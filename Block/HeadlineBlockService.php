...
namespace BrauneDigital\CmsBundle\Block;
...
class HeadlineBlockService extends BaseBlockService implements BlockServiceInterface
{
    protected $template = 'BrauneDigitalCmsBundle:Block:block_headline.html.twig';

...
class ImagineBlockService extends BaseBlockService implements BlockServiceInterface
{
    protected $template = 'BrauneDigitalCmsBundle:Block:block_imagine.html.twig';
